...
export default function CirclesBackground ({ right }) {
    ...
    return (
        <Div bg={pink}br="100%"wd="66rem" hg="60rem"
            pos="absolute"posLeft={right?"2rem":"-16rem"}posTop="0rem"
            boxSh={`12px 12px 2.5rem .2rem ${shadow}, inset ${right?"2rem -16rem":"-16rem -10rem"} 20rem ${darkPink}`}
            >


            <Div bg={violet}br="100%"wd="12rem" hg="12rem"
              pos="relative"posLeft="54rem"posBot="19rem"
              boxSh={`12px 12px 1.5rem .1rem ${shadow}, inset -1.3rem -1.3rem 4.5rem ${"#83679A"}`}
            >
            </Div>
            ...
            <Div bg={lightblue}br="100%"wd="7rem" hg="7rem"
              ...
              boxSh={`12px 12px 1.5rem .1rem ${shadow}, inset -1.2rem -.8rem 3.5rem ${"#869DB7"}`}
              >
            </Div>
