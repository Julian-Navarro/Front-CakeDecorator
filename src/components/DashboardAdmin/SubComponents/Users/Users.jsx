...
useEffect(()=>{
  ...
  console.log("USER: ",user);
    ...
    return (
        <Div flexDir="column"wd="100%"pd="10px"> 
          <Div wd="100%">
            {
              user !== false
                  ...
                  <Div hg="3.5rem"key={user.id}bg="#eee"br="0">
                        ...
                        <Div bg="#eee"pd="5px"flexDir="column"wd="15%"hg="100%"br="0"bdB="2px solid #333"bdR="2px solid #333">
                          ...
                          <Div jfCont="space-between">
                            <Button fWeight="bold"hg="1.2rem"bg="#333"br="4px"fSize=".7rem"pd="0 .5rem 0 .5rem" onClick={(e)=>{handlerViewUser(e, user)}}>Ver</Button>
                            <Button fWeight="bold"hg="1.2rem"bg="#333"br="4px"fSize=".7rem"pd="0 .5rem 0 .5rem" onClick={(e)=>{handlerBlockOrUnlockUser(e, user)}}>{user.status === "active" ? "Bloquear" :user.status ==="inactive"? "Bloquear?": "Desbloquear"}</Button>
                          </Div>
                        </Div>
                    </Div>
                )
