...
useEffect(()=>{},[allProducts, products])
    return (
        <Div flexDir="column"pd="5px">
          ...
          <Div overflow="hidden"bg="rgb(0,0,0,0.35)"br=".2rem .2rem 0 0"blur="blur(3px)"trans=".2s"pd="10px"pos="stijcky"posTop="0px"alSelf="flex-end"zInd="2"
            wd={productToEdit || createProductFlag ?"100%":"0px"}hg={productToEdit || createProductFlag ?"100vh":"1rem"}
            >

            <Div pos="absolute"posLeft={productToEdit || createProductFlag ?"0%":"20rem"}>
